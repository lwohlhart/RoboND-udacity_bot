...
\begin{itemize}      
      ...
      \item resample: randomly sample current particle set and inset new particles based on weighted probabilities
\end{itemize}
